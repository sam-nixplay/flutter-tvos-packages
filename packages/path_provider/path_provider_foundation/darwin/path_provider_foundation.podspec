...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'An iOS, tvOS, and macOS implementation of the path_provider plugin.'
  s.description      = <<-DESC
  An iOS, tvOS, and macOS implementation of the Flutter plugin for getting commonly used locations on the filesystem.
                       DESC
